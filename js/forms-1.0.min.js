	...
	window.tildaBrowserLang = window.navigator.userLanguage || window.navigator.language, window.tildaBrowserLang = window.tildaBrowserLang.toUpperCase(), -1 != window.tildaBrowserLang.indexOf("RU") ? window.tildaBrowserLang = "RU" : window.tildaBrowserLang = "EN", window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.tildaForm = {
		...
		window.tildaForm.captchaCallback = function (t) {
			...
			if (a || (a = "RUB" == r || "BYR" == r || "BYN" == r || "RUR" == r ? "ru-RU" : "UAH" == r ? "uk" : "en-US"), !window.cloudpaymentshandler) {
				...
				o = {
					language: a
				}, e.applePaySupport && "off" == e.applePaySupport && (o.applePaySupport = !1), e.googlePaySupport && "off" == e.googlePaySupport && (o.googlePaySupport = !1), window.cloudpaymentshandler = new cp.CloudPayments(o)
			}
			var i = {};
					...
					$.ajax({
						...
						success: function (r) {
							if ($("body").removeClass("t-body_popupshowed"), a.closest(".t-banktransfer").remove(), r || (r = {
								...
								}), r && r.error) return alert(r.error), !1;
				...
				return $.ajax({
					...
					error: function (t) {
						...
						if (a && 0 != a.length || (r.append('<p class="js-rule-error-all"></p>'), a = r.find(".js-rule-error-all")), !t || 0 == t.status && e < 100) a.html("Request error (opening block content panel). Please check internet connection...");
							...
							if (t && (t.status >= 500 || 408 == t.status || 410 == t.status || 429 == t.status || "timeout" == t.statusText) && -1 !== window.tildaForm.endpoint.indexOf("forms.tilda")) return window.tildaForm.endpoint = "127.0.0.1:5500", window.tildaForm.send($jform, btnformsubmit, formtype, formskey), !1;
